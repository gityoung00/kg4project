...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-blind.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-bounce.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-clip.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-drop.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-explode.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-fade.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-fold.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-highlight.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-size.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-scale.js', ["jquery", "../version", "../effect", "./effect-size"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-puff.js', ["jquery", "../version", "../effect", "./effect-scale"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-pulsate.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-shake.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-slide.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/effects/effect-transfer.js', ["jquery", "../version", "../effect"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/form-reset-mixin', ["jquery", "./form", "./version"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/accordion.js', ["jquery", "../version", "../keycode", "../unique-id", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/menu.js', ["jquery", "../keycode", "../position", "../safe-active-element", "../unique-id", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/autocomplete.js', ["jquery", "./menu", "../keycode", "../position", "../safe-active-element", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/checkboxradio.js', ["jquery", "../escape-selector", "../form-reset-mixin", "../labels", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/button', ["jquery", "./controlgroup", "./checkboxradio", "../keycode", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
    if (typeof define === "function" && define.amd) {
      define('ui/widgets/datepicker.js', ["jquery", "../version", "../keycode"], factory);
    } else {
      factory(jQuery);
    }
  }(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/mouse.js', ["jquery", "../ie", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/draggable.js', ["jquery", "./mouse", "../data", "../plugin", "../safe-active-element", "../safe-blur", "../scroll-parent", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/resizable.js', ["jquery", "./mouse", "../disable-selection", "../plugin", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
  $.widget("ui.resizable", $.ui.mouse, {
    ...
    _create: function() {
      var n, i, handle, axis, hname, margins, that = this,
        o = this.options;
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/dialog.js', ["jquery", "./button", "./draggable", "./mouse", "./resizable", "../focusable", "../keycode", "../position", "../safe-active-element", "../safe-blur", "../tabbable", "../unique-id", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/droppable.js', ["jquery", "./draggable", "./mouse", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/progressbar.js', ["jquery", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/selectable.js', ["jquery", "./mouse", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/selectmenu.js', ["jquery", "./menu", "../escape-selector", "../form-reset-mixin", "../keycode", "../labels", "../position", "../unique-id", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/slider.js', ["jquery", "./mouse", "../keycode", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/sortable.js', ["jquery", "./mouse", "../data", "../ie", "../scroll-parent", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/spinner.js', ["jquery", "./button", "../version", "../keycode", "../safe-active-element", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/tabs.js', ["jquery", "../escape-selector", "../keycode", "../safe-active-element", "../unique-id", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(factory) {
  if (typeof define === "function" && define.amd) {
    define('ui/widgets/tooltip.js', ["jquery", "../keycode", "../position", "../unique-id", "../version", "../widget"], factory);
  } else {
    factory(jQuery);
  }
}(function($) {
...
(function(a) {
  a.widget("mjs.nestedSortable", a.extend({}, a.ui.sortable.prototype, {
    ...
    _mouseDrag: function(c) {
      ...
      if (this.options.scroll) {
        var d = !1;
        this.scrollParent[0] != document && "HTML" != this.scrollParent[0].tagName ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - c.pageY < b.scrollSensitivity ? this.scrollParent[0].scrollTop = d = this.scrollParent[0].scrollTop + b.scrollSpeed : c.pageY - this.overflowOffset.top < b.scrollSensitivity && (this.scrollParent[0].scrollTop = d = this.scrollParent[0].scrollTop - b.scrollSpeed), this.overflowOffset.left + this.scrollParent[0].offsetWidth - c.pageX < b.scrollSensitivity ? this.scrollParent[0].scrollLeft = d = this.scrollParent[0].scrollLeft + b.scrollSpeed : c.pageX - this.overflowOffset.left < b.scrollSensitivity && (this.scrollParent[0].scrollLeft = d = this.scrollParent[0].scrollLeft - b.scrollSpeed)) : (c.pageY - a(document).scrollTop() < b.scrollSensitivity ? d = a(document).scrollTop(a(document).scrollTop() - b.scrollSpeed) : a(window).height() - (c.pageY - a(document).scrollTop()) < b.scrollSensitivity && (d = a(document).scrollTop(a(document).scrollTop() + b.scrollSpeed)), c.pageX - a(document).scrollLeft() < b.scrollSensitivity ? d = a(document).scrollLeft(a(document).scrollLeft() - b.scrollSpeed) : a(window).width() - (c.pageX - a(document).scrollLeft()) < b.scrollSensitivity && (d = a(document).scrollLeft(a(document).scrollLeft() + b.scrollSpeed)));
        !1 !== d && a.ui.ddmanager && !b.dropBehaviour && a.ui.ddmanager.prepareOffsets(this, c)
      }
      this.positionAbs = this._convertPositionTo("absolute");
      d = this.placeholder.offset().top;
      ...
      for (var e = this.items.length - 1; 0 <= e; e--) {
        ...
        if (h && g != this.currentItem[0] && this.placeholder[1 == h ? "next" : "prev"]()[0] != g && !a.contains(this.placeholder[0], g) && ("semi-dynamic" == this.options.type ? !a.contains(this.element[0], g) : 1)) {
          a(g).mouseenter();
          this.direction = 1 == h ? "down" : "up";
          if ("pointer" == this.options.tolerance || this._intersectsWithSides(f)) a(g).mouseleave(), this._rearrange(c, f);
          else break;
          this._clearEmpty(g);
      ...
      e = this.placeholder[0].parentNode.parentNode && a(this.placeholder[0].parentNode.parentNode).closest(".ui-sortable").length ? a(this.placeholder[0].parentNode.parentNode) : null;
      f = this._getLevel(this.placeholder);
      g = this._getChildLevels(this.helper);
      h = this.placeholder[0].previousSibling ? a(this.placeholder[0].previousSibling) : null;
      if (null != h)
        for (;
          "li" != h[0].nodeName.toLowerCase() || h[0] == this.currentItem[0] || h[0] == this.helper[0];)
          if (h[0].previousSibling) h = a(h[0].previousSibling);
          else {
            h = null;
            break
          } var k = this.placeholder[0].nextSibling ? a(this.placeholder[0].nextSibling) : null;
      if (null != k)
        for (;
          "li" != k[0].nodeName.toLowerCase() || k[0] == this.currentItem[0] || k[0] == this.helper[0];)
          if (k[0].nextSibling) k = a(k[0].nextSibling);
          else {
            k = null;
            break
          } var l = document.createElement(b.listType);
      this.beyondMaxLevels = 0;
      null != e && null == k && (b.rtl && this.positionAbs.left + this.helper.outerWidth() > e.offset().left + e.outerWidth() || !b.rtl && this.positionAbs.left < e.offset().left) ? (e.after(this.placeholder[0]), this._clearEmpty(e[0]), this._trigger("change", c, this._uiHash())) : null != h && (b.rtl && this.positionAbs.left + this.helper.outerWidth() < h.offset().left + h.outerWidth() - b.tabSize || !b.rtl && this.positionAbs.left > h.offset().left + b.tabSize) ? (this._isAllowed(h, f, f + g + 1), h.children(b.listType).length || h[0].appendChild(l), d && d <= h.offset().top ? h.children(b.listType).prepend(this.placeholder) : h.children(b.listType)[0].appendChild(this.placeholder[0]), this._trigger("change", c, this._uiHash())) : this._isAllowed(e, f, f + g);
    ...
    _mouseStop: function(c, b) {
      this.beyondMaxLevels && (this.placeholder.removeClass(this.options.errorClass), this.domPosition.prev ? a(this.domPosition.prev).after(this.placeholder) : a(this.domPosition.parent).prepend(this.placeholder), this._trigger("revert", c, this._uiHash()));
      for (var d = this.items.length - 1; 0 <= d; d--) this._clearEmpty(this.items[d].item[0]);
      this._trigger("complate", c, this._uiHash());
      a.ui.sortable.prototype._mouseStop.apply(this, arguments)
    },
    serialize: function(c) {
      var b = a.extend({}, this.options, c);
      c = this._getItemsAsjQuery(b && b.connected);
      var d = [];
      a(c).each(function() {
        var c = (a(b.item || this).attr(b.attribute || "id") || "").match(b.expression || /(.+)[-=_](.+)/),
          f = (a(b.item || this).parent(b.listType).parent(b.items).attr(b.attribute || "id") || "").match(b.expression || /(.+)[-=_](.+)/);
        c && d.push((b.key || c[1]) + "[" + (b.key && b.expression ? c[1] : c[2]) + "]=" + (f ? b.key && b.expression ? f[1] : f[2] : b.rootID))
      });
      !d.length && b.key && d.push(b.key + "=");
      return d.join("&")
    },
    toHierarchy: function(c) {
      function b(c) {
        var e = (a(c).attr(d.attribute || "id") || "").match(d.expression || /(.+)[-=_](.+)/);
        if (e) {
          var h = {
            id: e[2]
          };
          0 < a(c).children(d.listType).children(d.items).length && (h.children = [], a(c).children(d.listType).children(d.items).each(function() {
            var a = b(this);
            h.children.push(a)
          }));
          return h
      ...
      var d = a.extend({}, this.options, c),
        e = [];
      a(this.element).children(d.items).each(function() {
        var a = b(this);
        e.push(a)
      });
      return e
    ...
    toArray: function(c) {
      function b(c, g, l) {
        var m = l + 1,
          n;
        0 < a(c).children(d.listType).children(d.items).length && (g++, a(c).children(d.listType).children(d.items).each(function() {
          m = b(a(this), g, m)
        }), g--);
        n = a(c).attr(d.attribute || "id").match(d.expression || /(.+)[-=_](.+)/);
        c = g === e + 1 ? d.rootID : a(c).parent(d.listType).parent(d.items).attr(d.attribute || "id").match(d.expression || /(.+)[-=_](.+)/)[2];
        n && f.push({
          item_id: n[2],
          parent_id: c,
          depth: g,
      ...
      return f = f.sort(function(a, c) {
        return a.left - c.left
      })
    },
    _clearEmpty: function(c) {
      c = a(c).children(this.options.listType);
      !c.length || c.children().length || this.options.doNotClear || c.remove()
    },
    _getLevel: function(a) {
      var b = 1;
      if (this.options.listType)
        for (a = a.closest(this.options.listType); a && 0 < a.length && !a.is(".ui-sortable");) b++, a = a.parent().closest(this.options.listType);
      return b
    },
    _getChildLevels: function(c, b) {
      var d = this,
        e = this.options,
        f = 0;
      b = b || 0;
      a(c).children(e.listType).children(e.items).each(function(a, c) {
        f = Math.max(d._getChildLevels(c, b + 1), f)
      });
      return b ? f + 1 : f
    },
    _isAllowed: function(c, b, d) {
      var e = this.options,
        f = a(this.domPosition.parent).hasClass("ui-sortable") ? !0 : !1,
        g = this.placeholder.closest(".ui-sortable").nestedSortable("option", "maxLevels");
      !e.isAllowed(this.currentItem, c) || c && c.hasClass(e.disableNesting) || e.protectRoot && (null == c && !f || f && 1 < b) ? (this.placeholder.addClass(e.errorClass), this.beyondMaxLevels = g < d && 0 != g ? d - g : 1) : g < d && 0 != g ? (this.placeholder.addClass(e.errorClass), this.beyondMaxLevels = d - g) : (this.placeholder.removeClass(e.errorClass), this.beyondMaxLevels = 0)
    }
  }));
  ...
  $.extend($.fn.jGrowl.prototype, {
    ...
    render: function(notification) {
      ...
      var notification = $('<div class="jGrowl-notification ' + o.themeState + ' ui-corner-all' +
        ((o.group != undefined && o.group != '') ? ' ' + o.group : '') + '">' + '<div class="jGrowl-close">' + o.closeTemplate + '</div>' + '<div class="jGrowl-message">' + message + '</div></div>').data("jGrowl", o).addClass(o.theme).children('div.jGrowl-close').bind("click.jGrowl", function() {
    ...
    update: function() {
      ...
      if (this.notifications.length > 0 && (this.defaults.pool == 0 || $(this.element).find('div.jGrowl-notification:parent').length < this.defaults.pool))
...
/* /_res/plani/core.js */
(function(a) {
  a.debug = '?mode=' + Math.floor(Math.random() * 10);
  a.$.info = {
    isie: navigator.userAgent.toLowerCase().indexOf("trident") != -1 || navigator.userAgent.toLowerCase().indexOf("msie") != -1,
    ismobile: !(navigator.userAgent.toUpperCase().indexOf("MOBILE") == -1),
    isipad: !(navigator.userAgent.toUpperCase().indexOf("IPAD") == -1),
    isgalaxy: !(navigator.userAgent.toUpperCase().indexOf("SHW-M180") == -1),
    pathinfo: function(u) {
      var $l = u || location.href,
        $s = $l.split('/'),
        $h = /http:/.test($s[0]);
      return {
        domain: $h ? $s[2] : location.host,
        dir: $s.slice($h ? 3 : 0, $s.length - 1).join('/') + '/',
        self: $s[$s.length - 1].split("?")[0],
        qry: $s[$s.length - 1].split("?")[1],
        extension: $s[$s.length - 1].split("?")[0].split('.')[1],
    ...
    get: function(n) {
      ...
      for (key in $q) {
        if ($q[key].indexOf(n + '=') != -1) return $q[key].substring($q[key].lastIndexOf("=") + 1)
      };
      return ''
    },
    append: function(u) {
      ...
      for (key in u) {
        if (u[key] != '' && typeof $.imports[u[key]] == 'undefined') {
          $.imports[u[key]] = true;
          document.write('<script src=' + u[key] + '></script>')
        }
      }
    },
    style: function(u) {
      ...
      for (key in u) {
        if (u[key] != '' && typeof $.imports[u[key]] == 'undefined') {
          $.imports[u[key]] = true;
          document.write("<link rel=stylesheet type=text/css href=" + u[key] + " />")
        }
      }
    }
  };
  a.$.cookie = {
    time: new Date(),
    set: function(n, v, expire) {
      kill = new Date(this.time.getTime() + (expire * 1000));
      window.top.document.cookie = n + "=" + v + "; path=/; expires=" + kill.toGMTString();
    },
    get: function(n) {
      ...
      for (key in list) {
        ...
        if (list[key].indexOf(n + '=') != -1) {
          return list[key].split("=")[1]
        }
      };
      return false;
    },
    del: function(name) {
      var kill = new Date(this.time.getTime() - 3600);
      document.cookie = name + "=0; path=/; expires=" + kill.toGMTString()
    }
  }
})(window);
$.extend(jQuery, {
  ...
  browser: {
    ...
    mise: /msie/.test(navigator.userAgent.toLowerCase()),
...
$.extend(String.prototype, {
  isdate: function() {
    if (this.split('-').join('').split('/').join('').length < 8) {
      return false
    };
    return !isNaN(new Date(this.split('-').join('/')));
  },
  isempty: function() {
  ...
  format_number: function() {
    ...
    if (isNaN(n)) {
      ...
      return r.toString() + (!isNaN(x[1]) ? '.' + x[1] : '')
    }
  },
  format_int: function() {
    var t = this,
      x = t.split('.'),
      n = x[0].split(',').join('');
    return (isNaN(n) || n == '0') ? '' : n.toString() + (!isNaN(x[1]) ? '.' + x[1] : '');
  },
  sprintf: function() {
    var o = this;
    for (var i = 0; i < arguments.length; i++) {
      o = o.replace('%s', arguments[i])
    };
    return o
  }
});
$.extend({
  request: function(obj, func) {
    obj = $.extend({
      'url': '',
      'param': {},
      'dataType': 'html',
...
function __(string) {
  if (typeof langs[string] != 'undefined') {
    return langs[string];
  } else {
    return string;
  }
...
jQuery.event.special.swipeleft = jQuery.event.special.swiperight = jQuery.event.special.swipeup = jQuery.event.special.swipedown = {
  setup: function() {
    ...
    jQuery.event.add(this, 'touchstart.swipe mousedown.swipe', function(e) {
      try {
        pos.start_x = e.originalEvent.targetTouches[0].pageX;
        pos.start_y = e.originalEvent.targetTouches[0].pageY;
      } catch (exceptions) {
        pos.start_x = e.pageX;
        pos.start_y = e.pageY;
      }
      ...
      pos.start_time = pos_end_time = new Date();
    });
    jQuery.event.add(this, 'touchmove.swipe', function(e) {
      pos.end_x = e.originalEvent.targetTouches[0].pageX;
      pos.end_y = e.originalEvent.targetTouches[0].pageY;
      if (e.originalEvent.scale > 1) {
        e.originalEvent.preventDefault();
      }
    });
    jQuery.event.add(this, 'touchend.swipe mouseup.swipe', function(e) {
      try {
        pos.end_x = e.pageX;
        pos.end_y = e.pageY;
      } catch (exceptions) {}
      pos.end_time = new Date();
      var term_x = pos.end_x - pos.start_x,
        term_y = pos.end_y - pos.start_y,
        abs_x = Math.abs(term_x),
        abs_y = Math.abs(term_y),
        term_time = pos.end_time.getTime() - pos.start_time.getTime(),
        e_type = null;
      if ((abs_x >= sens.term || abs_y >= sens.term) && term_time >= sens.time) {
        if (abs_x > abs_y) {
          if (term_x < 0) {
            e_type = 'swipeleft';
          } else {
  ...
  teardown: function() {
    jQuery.event.remove(this, 'touchstart.swipe touchend.swipe touchmove.swipe mousedown.swipe mouseup.swipe');
  }
}
/* /_res/plani/custom.prototype.js */
$.fn.hook = function() {
  $('[helper]', $(this)).each(function() {
    var target = $(this),
  ...
  $('[class^=pi-form-]', $(this)).each(function() {
    var target = $(this),
  ...
  $(this).each(function() {
    ...
    obj.find('option').each(function() {
      ...
      if (this.value != '' || multiple == true) {
        opt.append($('<li />', {
          'tabindex': 0,
          'aix_value': this.value,
          'class': multiple == true && this.value == '' ? 'all' : ''
        }).html(html))
      }
    });
...
$.fn.ui_switch_classic = function() {
  $(this).each(function() {
    var obj = $(this),
      ...
      controll = $('<ul />', {
        'class': 'pi-form-switch-wrap'
      }).html("<span class='block' tabindex='0'></span><li class='sw on'>YES</li><li class='sw off'>NO</li><li class='txt'>" + span.text() + "</li>"),
      block = $('.block', controll);
    span.remove();
    obj.after(controll);
    obj.on('change', function() {
      block.stop().animate({
        'left': this.checked == true ? 40 : 0
      }, 'fast');
    }).trigger('change');
  ...
  $(this).each(function() {
    ...
    obj.on('click', function() {
      if (typeof this.href != 'undefined') {
        ...
        $.request({
          'url': this.href,
          param: form.serialize() + '&value=' + obj.attr('value')
        }, function(text) {
          icons = typeof params[text] != 'undefined' ? params[text] : ['<i class=\'fa fa-question-circle-o\'></i>', '#444'];
          obj.attr('value', text).css('color', icons[1]).html(icons[0]);
          if (typeof callback == 'function') {
...
$.fn.helper_datepicker = function(params) {
  ...
  $(this).each(function() {
    var obj = $(this),
      button = $('<button />', {
        'type': 'button',
        'class': 'pi-btn pi-icon month right-import'
      });
    try {
      if (obj.hasClass('hasDatepicker') == true) {
        obj.removeClass('hasDatepicker').removeAttr('id');
      } else {
        button.insertBefore(obj).on('click', function() {
          obj.focus();
        });
      }
      obj.datepicker(params);
      obj.addClass('right-import-input').on('change', function() {
...
$.fn.helper_colorpicker = function() {
  ...
  $(this).each(function() {
    var obj = $(this);
    obj.addClass('pi-helper-colorpicker-input cursor-hand').attr('readonly', true).css({
      ...
      $('.sl-marker', color_layer).one('mouseup', function() {
        color_layer.fadeOut();
      });
      color_layer.css({
...
$.fn.helper_tooltip = function(params) {
  ...
  $(this).each(function() {
    var obj = $(this),
      ...
      tip_layer = this.tip_layer || $('<span />', {
        'class': 'pi-helper-tooltip %s'.sprintf(params.color)
      }).html('<div class="triangle"></div><div class="message"></div>').appendTo('body')
    this.tip_layer = tip_layer;
    obj.addClass('cursor-hand').on('mouseenter focus focus_event', function(e) {
      var offset = obj.offset(),
        width = obj.innerWidth(),
        height = obj.outerHeight();
      ...
      if (obj.data('tooltip-title') != '') {
        ...
        tip_layer.css({
          'left': left - (tip_layer.width() / 2) + (width / 2),
          'top': top + ((tip_layer.height() + 25) * -1)
        }).fadeIn();
      }
...
$.fn.helper_clone = function(params) {
  ...
  $(this).each(function() {
    ...
    obj.delegate('.plus', 'click', function() {
...
$.fn.helper_ajax = function(params) {
  var params = $.extend({
    ...
    callback: function(target, data) {
      var container = target.next().hasClass('pi-helper-ajax-result') == true ? target.next() : $('<span />', {
        'class': 'pi-helper-ajax-result'
      }).insertAfter(target);
      container.html(data);
    }
  }, params);
...
$.extend($.module['form'].prototype, {
  __construct: function() {
    var $this = this;
    $this.platform.addClass('plani-form').prepend('<div class="alert-error"></div><div class="alert-success"></div>').end().on('submit', function() {
  ...
  detect: function() {
    var $this = this;
    $('input[type=text], input[type=radio], input[type=checkbox], select, textarea', $this.platform).each(function() {
      var choice_mode = this.type == 'radio' || this.type == 'checkbox'
      $(this).attr('detect', choice_mode == true ? this.checked : this.value).attr('detect-check', 'true').on('change', function() {
  ...
  _disposal: function(method) {
    ...
    $(':image, :submit, .submit', $this.platform).each(function() {
  ...
  _success: function(result, msg) {
    ...
    $('.alert-success', this.platform).html('<p>' + this.options['message'] + '</p>').fadeIn().find('p').append('<i class="fa fa-times"></i>').find('i').on('click', function() {
  ...
  _error: function(msg) {
    ...
    $('.alert-error', this.platform).html(msg).fadeIn('slow').find('p').append('<i class="fa fa-times"></i>').find('i').one('click', function() {
      $(this).closest('p').remove();
    });
...
$.extend($.module['modal'].prototype, {
  __layout: function() {
    if (this.layer.length < 1) {
      this.layer = $('<div />', {
        'class': 'plani-modal',
        'tabindex': 0
      }).html('<div class="modal-title"></div><div class="modal-frame"></div><iframe src="about:blank" class="modal-iframe" title="modal-iframe" />').appendTo('body');
    }
    if (this.bg.length < 1) {
      this.bg = $('<div />', {
        'class': 'plani-modal-bg'
      }).appendTo('body');
    }
    if (this.progress.length < 1) {
      this.progress = $('<i />', {
        'class': 'xi-spinner-1 xi-spin plani-modal-progress'
      }).appendTo(this.bg);
    }
  },
  __construct: function() {
    var $this = this;
    $this.platform.on('click', function() {
      if (this.tagName == 'IMG') {
        $this._imagebox(this);
      } else {
        $this._pagebox(this);
    ...
    $this.layer.undelegate('.close-button', 'click').delegate('.close-button', 'click', function() {
      $this.end();
      return false;
    }).undelegate('.prev-button', 'click').delegate('.prev-button', 'click', function() {
      $this.change($this.status.index - 1);
      return false;
    }).undelegate('.next-button', 'click').delegate('.next-button', 'click', function() {
      $this.change($this.status.index + 1);
      return false;
    });
  ...
  _pagebox: function(obj) {
    ...
    if ($this.options.iframe == true) {
      iframe.css({
        'height': 'auto'
      }).attr('src', obj_src).off('load').on('load', function() {
        var frame = $(this),
        ...
        $this.open($this._resize(img, true), true, function() {
      ...
      $.post(obj.getAttribute('href'), {}, function(data) {
        ...
        $this.timer = setTimeout(function() {
          ...
          $this.open($this._resize(img, true));
        }, 500);
      });
    }
  },
  _imagebox: function(obj) {
    var $this = this,
      img = $('<img />', {
        ...
        'alt': obj.getAttribute('alt') || $this.options.title
      }),
      frame = $('.modal-frame', $this.layer);
    $this.bg.fadeIn('slow');
    $this.status.open = true;
    ...
    img.off('load').on('load', function() {
      $this.open($this._resize(this, true));
    });
    $this.layer.focus();
...
$.extend($.module['nested.sortable'].prototype, {
  __construct: function() {
    ...
    $this.options.obj.group.on('click', function() {
      $this._import_group();
    });
    $this.ol.delegate('div', 'mouseenter', function() {
      if ($(this).hasClass('not-remove') == false) {
        $('<i class="fa fa-times tmp-button" style="right:14px"></i>').appendTo(this).on('click', function() {
          $this._remove(this);
        });
      }
      if ($(this).parents('ol').length < $this.options['item-level']) {
        $('<i class="fa fa-plus tmp-button" style="right:34px"></i>').appendTo(this).on('click', function() {
          $this._import(this);
        });
      }
      ...
      if (e.target.tagName.toLowerCase() == 'span') {
        ...
        target.html('<input type="text" value="' + target.text().trim() + '"/>').find('input').focus().one('focusout', function() {
  ...
  _latest: function() {
    ...
    $('li', this.platform).each(function() {
  ...
  _remove: function(obj) {
    var $this = this;
    $(obj).closest('li').slideUp(function() {
  ...
  _serialize: function() {
    ...
    for (var i = 0; i < serialized.length; i++) {
      ...
      postdata.append($('<input />', {
        'type': 'hidden',
        'name': 'sitemap[' + id + '][text]',
        'value': text
      }));
      postdata.append($('<input />', {
        'type': 'hidden',
        'name': 'sitemap[' + id + '][sort]',
        'value': sort
      }));
    }
...
$.extend($.module['nested.tree'].prototype, {
  __construct: function() {
    ...
    $('li:has(ul) .button', $this.ul).on('click', $this._open);
...
$.extend($.module['animate.flip'].prototype, {
  __construct: function() {
    ...
    $this.btn.flip.on('click', function() {
      $this._flip();
    });
    $this.btn.unflip.on('click', function() {
      $this._unflip();
    });
    setInterval
      (function() {
...
$.extend($.module['animate.tabs'].prototype, {
  __construct: function() {
    ...
    }).keyenter('click').eq($this.options.start).trigger('click');
  }
});
...
$.extend($.module['board.lists'].prototype, {
  ...
  _grid_set: function() {
    ...
    if (this.grid_options.paging == null) {
      this.grid_options.paging = $('<div />', {
        'class': 'plani-grid-paging'
      });
  ...
  _grid: function() {
    ...
    $this._grid_resize([_ths], _ths, true);
    $this.layer.mCustomScrollbar({
      ...
      callbacks: {
        ...
        whileScrolling: function() {
          $this._grid_resize([_ths, _tfoot_tds], _ths, true);
          $this._grid_scroll();
        }
      }
    });
    $this.pos_left = 0;
    $.window.off('resize.grid').on('resize.grid', function() {
      ...
      _table.removeAttr('id').colResizable({
        'minWidth': 60,
        'onResize': function(e) {
          $this._grid_resize_overap(_trows_cols, clone_th);
          $this._grid_resize([_ths, _tfoot_tds], clone_th, false);
        }
      });
      $this._grid_resize([_ths, _tfoot_tds], clone_th, false);
      $this._grid_resize([_ths, _tfoot_tds], clone_th, true);
      $this._grid_resize_overap(_trows_cols, _ths);
      $this._grid_scroll();
    });
    setTimeout(function() {
...
$.module['board.masonry'] = function(platform, options) {
  ...
  this.progress = $('<div />', {
    'class': 'progress'
  }).html('<i class="xi-spinner-1 xi-spin"></i>').appendTo(this.layer);
  this.empty = $('<div />', {
    'class': 'empty-data'
  }).html(__('검색 결과가 없습니다')).appendTo(this.layer);
  this.__construct();
}
$.extend($.module['board.masonry'].prototype, {
  ...
  _parse: function(html) {
    ...
    $this.resizer($this.layer.width(), 'reload');
  },
  _position: function(method) {
    var $this = this,
      ...
      latest_height = [];
    $items.stop().width(item_width).removeAttr('data-no').each(function(no) {
    ...
    $this.layer.stop().animate({
      'height': Math.max.apply(null, latest_height) + 50
    });
    return $return;
  },
  _top_sum: function(item_sort_top_target) {
    var h = 0;
    item_sort_top_target.each(function() {
      h += $(this).height();
    });
...
$.event.add(window, 'load', function() {
  ...
  function hook_addclass(target, opt) {
    var opt = $.extend({
      'class': 'transition',
      'delay': 10
    }, opt);
    window.setTimeout(function() {
      target.addClass(opt.class);
    }, opt.delay)
  }
  ...
  function hook_animate(target, opt) {
    ...
    window.setTimeout(function() {
      target.animate(opt.properties, opt.duration)
    }, opt.delay)
  }
  ...
  $('[pi-hook]').each(function() {
    var target = $(this);
    hook = target.attr('pi-hook').split('=');
    try {
      var func = hook[0],
        obj = JSON.parse(hook[1].replace(/\'/gi, '"'));
      eval('hook_' + func)(target, obj);
    } catch (e) {
      console.log('Syntax Error : ' + hook.join('='));
    }
  });
  NProgress.done();
});
...
$(function() {
  ...
  $(window).on('scroll load', function() {
    ...
    if ($(window).width() > 1023) {
      var btnfixed = $(window).scrollTop() < ($(document).outerHeight() - $(window).outerHeight() - 80);
      if (!btnfixed) {
        $('#footer_section .btn_top ').css('bottom', '19rem');
      } else {
        $('#footer_section .btn_top ').css('bottom', '6rem');
      }
    } else if ($(window).width() < 500) {
      $('#footer_section .btn_top ').css('bottom', '14.75rem');
    }
  });
  $('#footer_section .btn_top').on('click', function() {
    $('html, body').animate({
      scrollTop: 0
    });
    $(this.hash).focus();
...
$.fn.gnb1 = function(options) {
  ...
  return this.each(function() {
    ...
    $(document).on("mouseleave", settings.target, function() {
      $selecter.find('li').removeClass(settings.class);
      $(settings.target).removeClass(settings.class);
    });
  });
...
function sitemap3depth() {
  var dep3 = $(".submenu > ul > li");
  $('.submenu > ul > li').each(function() {
    if ($(this).find('.depth3').length > 0) {
      $(this).addClass('on');
    }
  });
  $('.submenu > ul > li.on > a').on('click', function(e) {
    var t = $(this);
    e.preventDefault();
    if (t.next(".depth3").is(":hidden")) {
      dep3.removeClass('inopen');
      t.parent('li').addClass('inopen');
    } else {
      t.parent('li').removeClass('inopen');
    }
  });
}
/* /_html/js/sub.js */
$(function() {
  ...
  $(".place_map_wrap area, .map_wrap area").click(function(event) {
    event.preventDefault();
    $('html,body').animate({
  ...
  $(window).on("load scroll", function() {
    ...
    var topBtn = $("#footer_section .btn_top");
    if (topBtn.length) {
  ...
  var numList = $(".map_number li");
  $("map area").on("mouseover", function() {
    var t = $(this).index();
    numList.removeClass("active");
    numList.eq(t).addClass("active");
  });
  $("map area").on("mouseleave", function() {
    numList.removeClass("active");
  });
  if ($('.card_view_wrap').length) {
    cardSlide();
    var eleCount = $('.card_list_slide .item').length;
    if (eleCount <= 4) {
      $('.card_list_slide .slick-list .slick-track').addClass('stop');
    }
  };
  if ($('.contents_inner').length) {
    $('.contents_inner').css('margin', '2rem auto');
  }
});

function m3depthActive() {
  var activeText = $('.depth3_tab li.active a').text();
  var activeBtn = '<button class="m_active"><span>' + activeText + '</span><i class="xi-angle-down-min"></i></button>';
  $('.depth3_tab').prepend(activeBtn);
  $('.m_active').show();
  $('.m_active').on('click', function(e) {
    e.preventDefault();
    $('.depth3_tab').toggleClass('on');
    var isOpen = $('.depth3_tab').hasClass('on');
    if (!isOpen) {
      $('html').removeAttr('style');
    } else {
      $('html').css('overflow', 'hidden');
...
function titleColorChange() {
  $('#contents_title').css('color', '#fff');
}

function cardSlide() {
  $('.card_img_slide').on('init', function(event, slick) {
    $('.card_view_wrap').find('.card_list_slide').before('<div class="slick-counter"><span class="current"></span> / <span class="total"></span></div>');
    $('.card_view_wrap').find('.current').text(slick.currentSlide + 1);
    $('.card_view_wrap').find('.total').text(slick.slideCount);
  });
  $('.card_img_slide').on('beforeChange', function(event, slick, currentSlide, nextSlide) {
    $('.card_view_wrap').find('.current').text(nextSlide + 1);
  });
  $('.card_img_slide').slick({
    asNavFor: '.card_list_slide',
  });
  $('.card_list_slide').slick({
    slidesToShow: 4,
    slidesToScroll: 1,
    asNavFor: '.card_img_slide',
    arrows: false,
    focusOnSelect: true,
    infinite: false,
    responsive: [{
