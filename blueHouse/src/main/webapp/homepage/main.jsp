	...
	<div id="wrap">
		...
		<header id="header" class="start">
			<div class="header_wrap">
				<h1 id="logo">
					<a href="/"> <img src="/blueHouse/img/logo.png"
				...
				<nav id="gnb1">
					<ul id="head_menu" class="topmenu">
						<li class="lnb2 mnfirst"><a
							href="http://localhost:8085/blueHouse/homepage/index1/open_message.jsp">개방의
								의미</a></li>
						<li class="lnb3"><a
							href="http://localhost:8085/blueHouse/homepage/index2/introduce-history.jsp">청와대
								소개</a>
							<div class="submenu">
								<ul class="sub03">
									<li class="sub02 subfirst"><a
										href="http://localhost:8085/blueHouse/homepage/index2/introduce-history.jsp">역사</a>
									</li>
									<li class="sub03"><a
										href="http://localhost:8085/blueHouse/homepage/index2/introduce-map00.jsp">지도
											및 주요시설</a></li>
									<li class="sub04"><a
										href="http://localhost:8085/blueHouse/homepage/index2/introduce-heritage.jsp">경내
											주요 유적</a></li>
								</ul>
							</div></li>
						<li class="lnb4"><a
							href="http://localhost:8085/blueHouse/homepage/index3/sub1.jsp">관람안내</a>
							<div class="submenu">
								<ul class="sub04">
									<li class="sub02 subfirst"><a
										href="http://localhost:8085/blueHouse/homepage/index3/sub1.jsp">관람시간
											및 해설안내</a></li>
									<li class="sub03"><a
										href="http://localhost:8085/blueHouse/homepage/index3/sub2.jsp">관람
											신청</a></li>
									<li class="sub04"><a
										href="http://localhost:8085/blueHouse/homepage/index3/sub3.jsp">안내도
											및 관람코스</a></li>
									<li class="sub05"><a
										href="http://localhost:8085/blueHouse/homepage/index3/sub4.jsp">활용
											프로그램</a></li>
									<li class="sub06"><a
										href="http://localhost:8085/blueHouse/homepage/index3/sub5.jsp">오시는
											길</a></li>
									<li class="sub07"><a
										href="http://localhost:8085/blueHouse/homepage/index3/event-tourism.jsp">함께
											가 볼 만한 장소</a></li>
									<li class="sub08"><a
										href="http://localhost:8085/blueHouse/homepage/index3/event-program.jsp">개방
											특별행사(5.10.~5.22.)</a></li>
									<li class="sub09"><a
										href="http://localhost:8085/blueHouse/homepage/index3/sub6.jsp">주말
											공연(5.28.~6.26.)</a></li>
								</ul>
							</div></li>
						<li class="lnb5"><a
							href="http://localhost:8085/blueHouse/homepage/index4/trail-summary.jsp">등산로</a>
							<div class="submenu">
								<ul class="sub05">
									<li class="sub02 subfirst"><a
									...
									<li class="sub03"><a
										href="http://localhost:8085/blueHouse/homepage/index4/trail-course.jsp">등산로
											코스</a></li>
									<li class="sub04"><a
										href="http://localhost:8085/blueHouse/homepage/index4/trail-relic.jsp">등산로
											이모저모</a></li>
								</ul>
							</div></li>
						<li class="lnb6"><a
							href="http://localhost:8085/blueHouse/homepage/index5/communicate-notice.jsp">국민소통</a>
							<div class="submenu">
								<ul class="sub06">
									<li class="sub02 subfirst"><a
						...
						<li class="lnb7"><a
							href="http://localhost:8085/blueHouse/homepage/index6/make-idea.jsp">내가
								만드는 청와대</a>
							<div class="submenu">
								<ul class="sub07">
									<li class="sub02 subfirst"><a
										href="http://localhost:8085/blueHouse/homepage/index6/make-idea.jsp">국민
											아이디어 제안</a></li>
									<li class="sub03"><a
										href="http://localhost:8085/blueHouse/homepage/index6/make-review.jsp">관람후기</a></li>
								</ul>
							</div></li>
					</ul>
				</nav>
				...
				<nav id="gnb2" class="">
					<a href="/" class="logo"><img src="/blueHouse/img/logo.png"
					...
					<h5 class="title">
						<img src="/blueHouse/img/sitemap_logo.png" alt=""> SITE MAP
					</h5>
					<ul id="head_menu_all" class="topmenu_all">
						<li class="lnb2 mnfirst active"><a
							href="http://localhost:8085/blueHouse/homepage/index1/open_message.jsp">개방의
								의미</a></li>
						<li class="lnb3  "><a
							href="http://localhost:8085/blueHouse/homepage/index2/introduce-history.jsp">청와대
							...
							<div class="submenu">
								<ul class="sub03">
									<li class="sub02 subfirst "><a
										href="http://localhost:8085/blueHouse/homepage/index2/introduce-history.jsp"><span>역사</span></a>
									</li>
									<li class="sub03 on"><a
										href="http://localhost:8085/blueHouse/homepage/index2/introduce-map00.jsp"><span>지도
												및 주요시설</span></a>
										<ul class="depth3">
											<li class="sub02 subfirst "><a
												href="http://localhost:8085/blueHouse/homepage/index2/introduce-map00.jsp">지도
													및 주요시설</a></li>
											<li class="sub03  "><a
												href="http://localhost:8085/blueHouse/homepage/index2/introduce-map01.jsp">청와대
													본관</a></li>
											<li class="sub04  "><a
												href="http://localhost:8085/blueHouse/homepage/index2/introduce-map02.jsp">영빈관</a></li>
											<li class="sub05  "><a
												href="http://localhost:8085/blueHouse/homepage/index2/introduce-map03.jsp">대통령
													관저</a></li>
											<li class="sub06  "><a
												href="http://localhost:8085/blueHouse/homepage/index2/introduce-map04.jsp">수궁터</a></li>
											<li class="sub07  "><a
												href="http://localhost:8085/blueHouse/homepage/index2/introduce-map05.jsp">상춘재</a></li>
											<li class="sub08  "><a
												href="http://localhost:8085/blueHouse/homepage/index2/introduce-map06.jsp">녹지원</a></li>
											<li class="sub09  "><a
												href="http://localhost:8085/blueHouse/homepage/index2/introduce-map07.jsp">대통령
													비서실</a></li>
											<li class="sub10  "><a
												href="http://localhost:8085/blueHouse/homepage/index2/introduce-map08.jsp">춘추관</a></li>
											<li class="sub11  "><a
												href="http://localhost:8085/blueHouse/homepage/index2/introduce-map09.jsp">무궁화
													동산</a></li>
											<li class="sub12  "><a
												href="http://localhost:8085/blueHouse/homepage/index2/introduce-map10.jsp">칠궁</a></li>
										</ul></li>
									<li class="sub04  "><a
										href="http://localhost:8085/blueHouse/homepage/index2/introduce-heritage.jsp"><span>경내
												주요 유적</span></a></li>
								</ul>
							</div></li>
						<li class="lnb4  "><a
							...
							<div class="submenu">
								<ul class="sub04">
									<li class="sub02 subfirst "><a
										href="http://localhost:8085/blueHouse/homepage/index3/sub1.jsp"><span>관람시간
												및 해설안내</span></a></li>
									<li class="sub03  "><a
										href="http://localhost:8085/blueHouse/homepage/index3/sub2.jsp"><span>관람
												신청</span></a></li>
									<li class="sub04  "><a
										href="http://localhost:8085/blueHouse/homepage/index3/sub3.jsp"><span>안내도
												및 관람코스</span></a></li>
									<li class="sub05  "><a
										href="http://localhost:8085/blueHouse/homepage/index3/sub4.jsp"><span>활용
												프로그램</span></a></li>
									<li class="sub06  "><a
										href="http://localhost:8085/blueHouse/homepage/index3/sub5.jsp"><span>오시는
												길</span></a></li>
									<li class="sub07  "><a
										href="http://localhost:8085/blueHouse/homepage/index3/event-tourism"><span>함께
												가 볼 만한 장소</span></a></li>
									<li class="sub08  "><a
										href="http://localhost:8085/blueHouse/homepage/index3/event-program"><span>개방
												특별행사(5.10.~5.22.)</span></a></li>
									<li class="sub09  "><a
										href="http://localhost:8085/blueHouse/homepage/index3/sub6.jsp"><span>주말
						...
						<li class="lnb5  "><a
							...
							<div class="submenu">
								<ul class="sub05">
									<li class="sub02 subfirst "><a
										href="http://localhost:8085/blueHouse/homepage/index4/trail-summary.jsp"><span>개요</span></a>
									</li>
									<li class="sub03  "><a
										href="http://localhost:8085/blueHouse/homepage/index4/trail-course.jsp"><span>등산로
												코스</span></a></li>
									<li class="sub04 on"><a
										href="http://localhost:8085/blueHouse/homepage/index4/trail-relic.jsp"><span>등산로
												이모저모</span></a>
										<ul class="depth3">
											<li class="sub02 subfirst "><a
												href="http://localhost:8085/blueHouse/homepage/index4/trail-relic.jsp">유적
													안내</a></li>
											<li class="sub03  "><a
												href="http://localhost:8085/blueHouse/homepage/index4/trail-application.jsp">관련
													앱</a></li>
										</ul></li>
								</ul>
							</div></li>
						...
						<li class="lnb7  "><a
							...
							<div class="submenu">
								<ul class="sub07">
									<li class="sub02 subfirst "><a
										href="http://localhost:8085/blueHouse/homepage/index6/make-idea.jsp"><span>국민
												아이디어 제안</span></a></li>
									<li class="sub03  "><a
										href="http://localhost:8085/blueHouse/homepage/index6/make-review.jsp"><span>관람후기</span></a>
									</li>
								</ul>
							</div></li>
					...
					<div id="visual"
						...
						<div class="fp-tableCell" style="height: 1252px;">
							<div class="visual_wrap">
								...
								<div class="v_item item1 on" style="">
									<div class="txt_box">
       ...
       <p class="a_tit "><2022.3.20 윤석열 당선인 인터뷰></p>
								...
								<div class="v_item item3" style="display: none;">
									<div class="txt_box">
										<p class="m_tit tLine2">“본관, 영빈관을 비롯하여..</p>
									</div>
									<div class="img_box">
				...
				<div class="section section1 fp-section fp-table"
					...
					<div class="fp-tableCell" style="height: 1252px;">
						<div class="m_container">
							...
							<div class="btn_area">
								<a href="/sub0303" class="defBtn fill arrow t2">청와대 개방 관람 신청</a>
							</div>
							...
							<ul class="tab_list">
								<li class="t1"><a href="/introduce-map00">
										<div class="item">
											<div>
												<img src="/blueHouse/img/homepage/icon_sec1_1.png" alt="">
												<strong>지도로 보는 시설소개</strong>
											</div>
										</div>
								</a></li>
								<li class="t2"><a href="/introduce-history">
										<div class="item">
											<div>
												<img src="/blueHouse/img/homepage/icon_sec1_2.png" alt="">
												<strong>청와대 역사</strong>
											</div>
										</div>
								</a></li>
								<li class="t3"><a href="/introduce-heritage">
										<div class="item">
											<div>
												<img src="/blueHouse/img/homepage/icon_sec1_3.png" alt="">
												<strong>경내 주요 유적</strong>
											</div>
										</div>
								</a></li>
							</ul>
										...
										<div class="slick-track"
											...
											<div class="item slick-slide slick-current slick-active"
												...
												<div class="inner">
													...
													<div class="box">
														<span>약속을 담다</span>
														<p>74년 만에 국민의 품으로 완전히 돌아오는 역사적인 순간을 축하하는 공연들을 청와대 본관 앞
															대정원에 담아봅니다.</p>
													</div>
												</div>
											</div>
													...
													<li class="slick-slide slick-current slick-active"
														...
														href="/make-review/view/id/1313" tabindex="0"> <span
															...
															<div class="rp_detail">
																...
																<div class="rp_desc">
																	<div>오래 살다 보니 청와대를 고궁처럼 구경 할 날도 오네요 갔던 날 날씨도 화장했고
																		공기도 좋아 청와대의 아름다움을 더 실감했습니다 조선시대 궁 보다 더 멋졌습니다 드 넓은 풀밭도
																		3개 정도 되는거 같은데 일단 2개만 그날 봤습니다 조그마한 계곡이 흐르는 곳도 있더군요 상상보다
																		훨씬 멋진곳이 였습니다 앞으로 내부도 공개 한다니 또 가 보려고 합니다 청와대를 국민 품에
																		돌려주신 윤석렬대통령께 감사드립니다 그동안 망쳐놓은 나라를 다시 회복 시켜 주세요 늘 응원합니다</div>
																</div>
															</div>
													</a></li>
															...
															<div class="rp_detail">
																...
																<div class="rp_desc">
																	<div>5월의 아침 코로나로 답답했던 국민에게 청와대 개방은 너무 소중한
																		...
																		너무 넓고 광활하여 입장 후 여유롭게 가족들과 배포해준 안내도 맞춰 산책을 즐겼고 힐링하였습니다.
																		단지 입구에서 줄 정비하던 업체 안내하는 담담자 남자 한분이 너무 무례하게 소리치는 분 계셔서
																		해당업체에 주의 부탁드리며 입구 줄 세우고 관리하는 업체 좀더 신경써서 주심 감사하겠습니다.
																		그리고 미륵불 올라가는 곳 테크 많은 분이 다니셔서 보강하고 체크 부탁드립니다. 건물들 개방하실때
																		좀더 정비해주시고 과거에 일제의해 옮겨진 미륵불도 나쁜과거사를 기억할 수 있도록 미륵불도 현자리에
																		잘 유지 보존해 주세요. 건물 개방하면 또 놀러 가고 싶어요!!</div>
																</div>
															</div>
													</a>
													</li>
															...
															<div class="rp_detail">
																...
																<div class="rp_desc">
																	<div>54년만에 일반인 개방된 북악산 청와대 뒷길을 갔다왔다 잘 정돈된 탐방로에
																		아름드리 숲속을 걷고 우리 민족의 역사가 고스란히 담긴 길을 걸으며 옛 조상들의 발자취와 숨소리를
																		느낄수 있었고 청와대 전망대에서 바라본 광화문 세종로 남산 에 이르는 전망은 숨이 막힐정도의
																		웅장함과 산새의 아름다움이 내가슴을 뛰게 했다 내려오는 길에 꽃길과 청와대 앞길 칠궁에 이르는
																		산책로도 좋았다 곳곳에 안내원이 탐방객들을 친절하게 안내해 주었고 부족한 화장실을 경찰차
																		화장실차가 지원을해주는 광경이 이색적이었다 한가지 청와대 춘추관 정문 칠궁에 이르는 곳에는
																		편의점이 없다 보니 기본적인 물이나 음료를 구할수가 없었고 잠시라도 앉아서 쉬려면 카페를 들어가야
																		하는 아쉬움이 있었다 그래도 총평은 아주 좋았고 우리명산 우리청와대를 세계적인 관광명소로 많은
																		사랑이 찾는 우리민족의 자랑이었으면 좋겠다</div>
																</div>
															</div>
													</a>
													</li>
