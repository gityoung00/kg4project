...
<body>
	...
	<header id="header" class="on">
		<div class="header_wrap">
			<h1 id="logo">
				<a href="/"> <img
					src="/blueHouse/www.opencheongwadae.kr/_html/img/layout/logo.png"
					alt="청와대, 국민 품으로" class="n_ov"><img
					src="/blueHouse/www.opencheongwadae.kr/_html/img/layout/logo_black.png"
			...
			<nav id="gnb2" class="">
				<a href="/" class="logo"><img
					src="/blueHouse/www.opencheongwadae.kr/_html/img/layout/logo.png"
					alt="청와대, 국민 품으로" class="n_ov"></a> <a
					href="https://www.korea.net/Government/Current-Affairs/National-Affairs?affairId=2247"
					class="global" target="_blank">EN<span class="sr_only">영문
						홈페이지로 이동</span></a> <a href="" class="control open">전체 메뉴 열기</a>
				<h5 class="title">
					<img
						src="/blueHouse/www.opencheongwadae.kr/_html/img/layout/sitemap_logo.png"
						alt=""> SITE MAP
				</h5>
