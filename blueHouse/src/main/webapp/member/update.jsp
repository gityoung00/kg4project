...
%>
		 			<tr>
			 			<td colspan="2">
			 				<label>아이디</label><br>
			 				<input type="text" tabIndex="1" onkeydown="return tab(this, event)" name="id" id="id" class="reigster-id" value="<%=id %>" readonly><br>
		 			...
		 			<tr>
		 				<td colspan="2">
			 				<label>이름</label><br>
			 				<input type="text" tabIndex="4" onkeydown="return tab(this, event)" name="name" id="name" class="reigster-name" placeholder="홍길동" onchange="nameCheck()" value="<%=name %>"><br>
		 			...
		 			<tr>
		 				<td colspan="2">
			 				<label>전화번호</label><br>
			 				<input type="text" tabIndex="5" onkeydown="return tab(this, event)" name="tel" id="tel" class="reigster-tel" value="<%=tel %>" readonly><br>
		 			...
		 			<tr>
		 				<td colspan="2">
			 				<label>이메일</label><br>
			 				<input type="text" tabIndex="6" onkeydown="return tab(this, event)" name="email" id="email" class="reigster-email" value="<%=email %>" readonly><br>
