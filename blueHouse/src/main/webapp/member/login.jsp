...
<style>
	...
	.login-id, .login-pw {
		...
		padding: 5px;
		border: 0;
		border-bottom: 2px solid #19a0b5;
		width: 500px;
		font-size: 20px;
	}
	...
	<div id="member-block">
		...
		<form action="loginSvc.jsp" method="post" id="f">
	 		<table class="login-input">
	 			<tr>
		 			<td colspan="2">
		 				<input type="text" name="id" class="login-id" placeholder="아이디 입력">
		 			</td>
	 			</tr>
	 			<tr>
		 			<td colspan="2">
		 				<input type="password" name="pw" class="login-pw" placeholder="비밀번호 입력">
		 			</td>
	 			</tr>
	 			
	 			<tr>
		 			<td><input type="submit" class="login-submit" value="로그인"></td>
		 			<td><input type="button" class="login-register" value="회원가입" onclick="location.href='register.jsp'"></td>
	 			</tr>
	 		</table>
	 	</form>
